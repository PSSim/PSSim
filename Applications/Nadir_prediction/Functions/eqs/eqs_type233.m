...
vf    = z(pointer_sv(i)+7);
xg1   = z(pointer_sv(i)+8);
xg2   = z(pointer_sv(i)+9);
xg3   = z(pointer_sv(i)+10);
...
if (genout ==i)
    ...
    out(pointer_sv(i)+8)  = (1/T1)*(min(aux1,aux2)-xg1);
    out(pointer_sv(i)+9)  = (1/T2)*(xg1_sat-xg2);
    out(pointer_sv(i)+10) = (1/T3)*(xg2-xg3);
